...
# MiMo-VL-7B-SFT training (ms-swift)
# Fill in paths before running.

MODEL_PATH="/path/to/MiMo-VL-7B-SFT"
DATASET_JSON="/path/to/annotations.json"
OUTPUT_DIR="/path/to/output/mimo_vl_7b"
LOG_DIR="/path/to/logs/mimo_vl_7b"
