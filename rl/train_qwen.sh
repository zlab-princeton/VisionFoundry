...
# Qwen2.5-VL-3B-Instruct full-parameter GRPO on one 8-GPU node.
: "${VERL_ROOT:?Set VERL_ROOT to a verl v0.4.1 checkout}"
: "${MODEL_PATH:?Set MODEL_PATH to Qwen2.5-VL-3B-Instruct}"
...
RUN_NAME=${RUN_NAME:-qwen2_5_vl_3b_visionfoundry_grpo}
TRAIN_BATCH_SIZE=${TRAIN_BATCH_SIZE:-128}
TRAIN_LR=${TRAIN_LR:-4e-6}
